...
function inferSizeSegment(band, v) { const t=lower(band||''); v=Number(v)||0; if(/\b(50m|5m|enterprise)\b|\$5m/.test(t)||v>=5000000)return'Enterprise / large merchant'; if(/\b(1m|5m|mid|500k)\b/.test(t)||v>=500000)return'Mid-market'; if(v>0)return'SMB'; return'Unknown'; }
